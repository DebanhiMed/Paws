...
class CardViewModel{
    ...
    func getPost(){
        ...
        card = CardModel(icon: "pawIcon", name: "Val", username: "@valbuenisima", petImage: "weima", place: "Monterrey, Nuevo León", date: "15/03/2024", description: "Un perro grande afuera de mi trabajo, lo rescate y lo resguarde")
        array.append(card)
        
        card = CardModel(icon: "pawIcon", name: "HectorArroyo", username: "@pspsps", petImage: "deichi", place: "Monterrey, Nuevo León", date: "02/05/2024", description: "Perro no reconocido, lo encontre por mi colonia y tenía mucha hambre")
        array.append(card)
